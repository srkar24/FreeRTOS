...
void StartNormalTask(void *argument)
{
  ...
  for(;;)
  {
	  uint8_t str1[] = "Entered MediumTask\r\n";
	  HAL_UART_Transmit(&huart2, (uint8_t *) str1, sizeof(str1), 100);
	  HAL_Delay(500);
	  uint8_t str2[] = "Leaving MediumTask\r\n\r\n";
	  HAL_UART_Transmit(&huart2, (uint8_t *) str2, sizeof(str2), 100);
	  osDelay(500);
  }
...
void StartHighTask(void *argument)
{
  ...
  for(;;)
  {
    uint8_t str1[]= "Entered [HighTask] and waiting for Semaphore\r\n";
    HAL_UART_Transmit(&huart2, (uint8_t *) str1, sizeof(str1), 100);

    osSemaphoreAcquire(BinarySemHandle, osWaitForever);

    uint8_t str3[]= "Semaphore acquired by HIGH Task\r\n";
    HAL_UART_Transmit(&huart2, (uint8_t *) str3, sizeof(str3), 100);

    uint8_t str2[]= "Leaving HighTask and releasing Semaphore\r\n\r\n";
    HAL_UART_Transmit(&huart2, (uint8_t *) str2, sizeof(str2), 100);
