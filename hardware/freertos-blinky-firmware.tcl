...
#
# freertos-blinky-firmware.tcl: Tcl script for re-creating project 'freertos-blinky-firmware'
#
# Generated by Vivado on Wed Dec 06 20:37:54 -0800 2023
...
#
# 1. This project restoration tcl script (freertos-blinky-firmware.tcl) that was generated.
#
...
set _xil_proj_name_ "freertos-blinky-firmware"
...
set script_file "freertos-blinky-firmware.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/build/freertos-blinky-firmware"]"
...
# Proc to create BD subsystem
proc cr_bd_subsystem { parentCell } {
  ...
  set leds_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 leds_out ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports leds_out] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.671698",
   "Default View_TopLeft":"-241,-350",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1310 -y -60 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1310 -y -30 -defaultsOSRD
preplace port leds_out -pg 1 -lvl 5 -x 1310 -y -100 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 440 -y 0 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 1 -x 140 -y -60 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 4 -x 1150 -y -230 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 3 -x 820 -y 70 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 20 20 250 110 650 -190 990
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 N 50
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 4 30 170 NJ 170 NJ 170 1000
preplace netloc processing_system7_0_DDR 1 2 3 NJ -50 1010 -60 N
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ -30 N -30 N
preplace netloc axi_gpio_0_GPIO 1 1 4 250J -110 640J -100 NJ -100 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 630 -290 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 5 20 -140 NJ -140 NJ -140 990J -110 1290
levelinfo -pg 1 0 140 440 820 1150 1310
pagesize -pg 1 -db -bbox -sgen 0 -350 1420 250
"
}
...
# End of cr_bd_subsystem()
cr_bd_subsystem ""
set_property REGISTERED_WITH_MANAGER "1" [get_files subsystem.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files subsystem.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse subsystem.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/build/freertos-blinky-firmware/freertos-blinky-firmware.gen/sources_1/bd/subsystem/hdl/subsystem_wrapper.v" ]
} else {
