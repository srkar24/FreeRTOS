...
void StartTask1(void *argument)
{
  ...
  {
	  osDelay(1000);
	  uint8_t tx_buff[] = "Hello World from Task 1\r\n";
...
void StartTask2(void *argument)
{
  ...
  {
	  osDelay(2000);
	  uint8_t tx_buff[] = "Hello World from Task 2\r\n";
	  HAL_UART_Transmit(&huart2, tx_buff, sizeof(tx_buff), 10);
  }
...
void StartTask3(void *argument)
{
  ...
  {
	  osDelay(3000);
	  uint8_t tx_buff[] = "Hello World from Task 3\r\n";
	  HAL_UART_Transmit(&huart2, tx_buff, sizeof(tx_buff), 10);
  }
...
void StartTask4(void *argument)
{
  ...
  {
	  osDelay(4000);
	  uint8_t tx_buff[] = "Hello World from Task 4\r\n";
	  for (int i=0; i < 3; i++) {
		  HAL_UART_Transmit(&huart2, tx_buff, sizeof(tx_buff), 10);
		  HAL_Delay(1000);
	  }
